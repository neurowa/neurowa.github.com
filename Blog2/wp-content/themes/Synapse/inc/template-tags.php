...
function twentysixteen_entry_meta() {
	if ( 'post' === get_post_type() ) {
		...
		printf( '</br><span class="byline" style="padding-right:10px"><span class="author vcard"><span style="padding:10px">%1$s</span><span class="screen-reader-text">%2$s </span> <a class="url fn n" href="%3$s">%4$s</a></span></span>',
...
function twentysixteen_entry_date() {
	...
	printf( '<span class="posted-on" style="padding-right:10px"><span class="screen-reader-text">%1$s </span><a href="%2$s" rel="bookmark">%3$s</a></span>',
